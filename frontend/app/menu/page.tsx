...
// Kitchen gallery images
const galleryLayout = [
  { src: "/kitchen/kitchen.jpg", title: "Main Kitchen" }, 
  { src: "/dining/dining3.jpg", title: "Dining Setup" },  
  { src: "/kitchen/kitchen1.jpg", title: "Prep Area" },   
  { src: "/kitchen/kitchen2.jpg", title: "Cooking Station" }, 
  { src: "/dining/dining6.jpg", title: "Ambience" },      
  { src: "/kitchen/kitchen3.jpg", title: "Fresh Ingredients" }, 
  { src: "/dining/dining7.jpg", title: "Table View" },    
];
...
export default function MenuPage() {
  ...
  const goToPrevious = () => {
    setCurrentIndex((prevIndex) =>
      prevIndex === 0 ? galleryLayout.length - 1 : prevIndex - 1
    );
  };

  const goToNext = () => {
    setCurrentIndex((prevIndex) =>
      prevIndex === galleryLayout.length - 1 ? 0 : prevIndex + 1
    );
  };
  ...
  return (
    <>
      ...
      <main className="bg-[#FDFBF7] text-[#112A46] selection:bg-[#fcd34d]/90 selection:text-[#112A46] dark:bg-[#1E1E1E] dark:text-white transition-colors duration-300">
        ...
        {/* ================= KITCHEN & DINING CAROUSEL (Light/Dark mode) ================= */}
        <section className="relative w-full bg-[#FDFBF7] dark:bg-black py-24 border-t border-[#112A46]/10 dark:border-white/10 transition-colors duration-300">
            ...
            <div className="relative w-full flex items-center justify-center max-w-6xl mx-auto">
              ...
              <div className="w-full bg-white dark:bg-[#1A1B1E] border border-slate-200 dark:border-transparent rounded-2xl p-4 sm:p-6 flex flex-col gap-4 shadow-xl dark:shadow-2xl transition-colors duration-300">
                ...
                <div className="relative w-full aspect-video sm:aspect-[21/9] bg-slate-100 dark:bg-[#0F0F11] rounded-xl overflow-hidden transition-colors duration-300">
                  <Image
                    src={galleryLayout[currentIndex].src}
                    alt={galleryLayout[currentIndex].title}
                    fill
                  ...
                  <div className="absolute bottom-3 left-4 text-slate-800 dark:text-white/90 text-sm md:text-base font-medium drop-shadow-sm dark:drop-shadow-lg bg-white/90 dark:bg-black/60 px-3 py-1.5 rounded-md backdrop-blur-sm border border-slate-200 dark:border-white/10 transition-colors duration-300">
                    {currentIndex + 1}/{galleryLayout.length} - {galleryLayout[currentIndex].title}
                  </div>
                </div>
                    ...
                    {galleryLayout.map((img, index) => (
                      <button
                        ...
                        className={`
                          ...
                          ${
                            currentIndex === index
                              ? "ring-2 ring-[#112A46] dark:ring-white scale-[1.02] opacity-100" // Active state matches light/dark theme
                              : "opacity-40 hover:opacity-100" // Inactive state
                          }
                        `}
                      >
                        <Image
